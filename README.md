...
<p align="center">
  <img src="./prototipos/final/petzona-capa-readme.png" width="100%" alt="PetZona — Case acadêmico de UX/UI">
</p>---

🎯 O desafio

A experiência de quem cuida de um animal muitas vezes envolve diferentes canais para:
...
- acompanhar serviços realizados no pet.
...
A proposta não é apenas facilitar uma compra ou contratação, mas considerar também a experiência do usuário antes, durante e depois do serviço.

---

🧩 Processo de UX/UI

O desenvolvimento do projeto passou por diferentes etapas:

Persona → Jornada do usuário → Fluxos → Wireframes → Baixa fidelidade → Alta fidelidade → Protótipo navegável

Durante o processo foram observados pontos como:
...
- confiança durante a contratação;
...
A jornada foi utilizada para entender os diferentes pontos de contato entre o tutor e o serviço, permitindo identificar oportunidades de melhoria ao longo da experiência.
...
O protótipo permite navegar pelas principais etapas da experiência do PetZona.

🔗 Protótipo navegável

"▶️ Acessar o protótipo de alta fidelidade no Figma" (https://www.figma.com/proto/Ripqn3W1myctZpxt2WZKOI/Petzona?t=2pz6zE0tCU7RMyBX-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1&node-id=6-2)
...
<p align="center">
  <img src="./prototipos/final/petzona-final-01-05.png" width="100%" alt="Fluxo de produtos do PetZona">
</p>🐾 Serviços
...
<p align="center">
  <img src="./prototipos/final/petzona-final-06-10.png" width="100%" alt="Fluxo de serviços do PetZona">
</p>---
...
Alguns pontos considerados durante o projeto:

- informações claras antes da contratação;
- redução de atritos durante a navegação;
...
- possibilidade de relacionamento e retenção do cliente.
...
Durante a evolução da interface também foram considerados princípios que ajudam a tornar a experiência mais acessível, como:
...
O desenvolvimento do PetZona permitiu trabalhar não apenas a construção visual das telas, mas também decisões relacionadas à experiência.
...
- manter consistência visual entre diferentes funcionalidades;
...
Embora o protótipo de alta fidelidade esteja concluído, o projeto ainda pode evoluir com:
...
As informações apresentadas nas telas, incluindo:
...
são utilizadas apenas para fins demonstrativos dentro do protótipo.
